...
export const editButton = requireElement<HTMLButtonElement>('edit-button');
export const saveButton = requireElement<HTMLButtonElement>('save-button');
export const cancelButton = requireElement<HTMLButtonElement>('cancel-button');
export const documentEditor = requireElement<HTMLTextAreaElement>('document-editor');
